    ...
    <div className="flex h-full flex-col">
      ...
      >
        <div className="flex items-end gap-2">
          <div className="flex flex-1 items-end rounded-md border border-input bg-background px-2 py-2 shadow-xs focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-[3px]">
            <Button
              type="button"
              size="icon"
              variant="ghost"
            ...
            <textarea
              ...
              disabled={loading}
              rows={1}
              className="flex-1 resize-none bg-transparent px-3 py-0 text-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:opacity-50"
            />
            <Button
              type="button"
              size="icon"
